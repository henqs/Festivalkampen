			...
			<div id="header-wrapper">
				<header id="header" class="container">
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								<li class="current"><a name="toppen" href="index.scala.html">Välkommen</a></li>
								<li>
									<a href="">Droppmeny</a>
									<ul>
										<li><a href="#">Din grupp</a></li>
								...
								<li><a href=""""),_display_(/*137.23*/routes/*137.29*/.Application.gruppSida()),format.raw/*137.53*/("""">Gruppsida</a></li>
						...
						<div class="4u">
							...
							<!-- Box -->
								<section class="box feature">
									<a href="#" class="image featured"><img src=""""),_display_(/*171.56*/routes/*171.62*/.Assets.at("images/pic02.jpg")),format.raw/*171.92*/("""">
									<div class="inner">
										<header>
						...
						<div class="4u">
							...
							<!-- Box -->
								<section class="box feature last">
									<a href=""""),_display_(/*201.20*/routes/*201.26*/.Application.gruppSida()),format.raw/*201.50*/("""" class="image featured"><img src=""""),_display_(/*201.86*/routes/*201.92*/.Assets.at("images/pic03.jpg")),format.raw/*201.122*/("""">
									<div class="inner">
										<header>
											<h2><a href=""""),_display_(/*204.26*/routes/*204.32*/.Application.gruppSida()),format.raw/*204.56*/("""">Klicka här för att komma till gruppsidan</a></h2>
											<p>Möt din grupp!</p>
										</header>
									...
									<section class="widget thumbnails">
										...
										<div class="grid">
											<div class="row no-collapse 50%">
												<div class="6u"><a href="#" class="image fit"><img src=""""),_display_(/*229.70*/routes/*229.76*/.Assets.at("images/pic04.jpg")),format.raw/*229.106*/("""" alt="" /></a></div>
												<div class="6u"><a href="#" class="image fit"><img src=""""),_display_(/*230.70*/routes/*230.76*/.Assets.at("images/pic05.jpg")),format.raw/*230.106*/("""" alt="" /></a></div>
											</div>
											<div class="row no-collapse 50%">
												<div class="6u"><a href="#" class="image fit"><img src=""""),_display_(/*233.70*/routes/*233.76*/.Assets.at("images/pic06.jpg")),format.raw/*233.106*/("""" alt="" /></a></div>
												<div class="6u"><a href="#" class="image fit"><img src=""""),_display_(/*234.70*/routes/*234.76*/.Assets.at("images/pic07.jpg")),format.raw/*234.106*/("""" alt="" /></a></div>
											</div>
										</div>
						...
						<div class="3u">
							...
							<!-- Links -->
								<section class="widget links">
									...
									<ul class="style2">
										<li><a href=""""),_display_(/*281.25*/routes/*281.31*/.Application.gruppSida()),format.raw/*281.55*/("""">Klicka här för att komma till gruppsidan</a></li>
						...
						<div class="3u">
							...
							<!-- Contact -->
								<section class="widget contact last">
									<h3><a name="kontakta"> Kontakta oss</a></h3>
									<ul>
